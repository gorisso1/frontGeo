...
function ReportPage() {
    ...
    const handleAddSmallClick = async (e) => {
        e.preventDefault();
        ...
        try {
            ...
            const response = await sendGetRequestAndDownloadFile(`generate-single-report/?start_time=${formData.date1}&end_time=${formData.date2}`, `${formData.date1}_${formData.date2}.xlsx`);
                ...
                <Form onSubmit={handleAddClick}>
                    ...
                    <div className='block'>
                        <Col className='admin-botton'>
                            <div className="d-grid gap-2" style={{marginRight: '10px'}}>
                        ...
                        <Col className='admin-botton'>
                            <div className="d-grid gap-2" style={{marginTop: '0'}}>
                                <Button className='admin-botton-color' variant="dark" type='submit' size='lg'
                                        onClick={handleAddSmallClick}>Скачать
                                    маленький отчет</Button>
                            </div>
                        </Col>
                    </div>
                </Form>
